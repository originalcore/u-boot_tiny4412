 ...
 *
 * Configuration settings for the FrendlyARM TINY4412 EXYNOS4210) board.
 *
...
#define CONFIG_SYS_TEXT_BASE		0x43E00000   /* U-boot link address */
...
/* Because BL1 will copy bl2(SPl) to iram address 0x2023400 */
